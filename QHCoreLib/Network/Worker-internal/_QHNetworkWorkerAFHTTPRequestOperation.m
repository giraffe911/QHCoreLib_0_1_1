//
//  QHNetworkWorkerQHHTTPRequestOperation.m
//  QQHouse
//
...
static QHHTTPSessionManager *httpManager;
static QHHTTPSessionManager *htmlManager;
static QHHTTPSessionManager *jsonManager;
static QHHTTPSessionManager *imageManager;


@interface QHNetworkWorkerQHHTTPRequestOperation ()
...
@implementation QHNetworkWorkerQHHTTPRequestOperation
...
+ (void)initialize
{
    ...
    dispatch_once(&onceToken, ^{
        ...
        httpManager = [QHHTTPSessionManager manager];
        httpManager.responseSerializer = [QHHTTPResponseSerializer serializer];
        
        htmlManager = [QHHTTPSessionManager manager];
        htmlManager.responseSerializer = [AFHTMLResponseSerializer serializer];

        jsonManager = [QHHTTPSessionManager manager];
        jsonManager.responseSerializer = [AFJSONResponseSerializer serializer];

        imageManager = [QHHTTPSessionManager manager];
...
- (QHHTTPSessionManager *)p_manager
{
...
- (void)p_createNormalTask
{
    ...
    QHHTTPSessionManager *manager  = managerForResourceType[@(self.request.resourceType)];
